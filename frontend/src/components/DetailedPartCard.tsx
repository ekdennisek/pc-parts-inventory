                ...
                return (
                    <>
                        ...
                        {storageDevice.readSpeed && (
                            <div className="spec-item">
                                <span className="spec-label">Read</span>
                                <span className="spec-value">{storageDevice.readSpeed} MB/s</span>
                            </div>
                        )}
                        {storageDevice.writeSpeed && (
                            <div className="spec-item">
                                <span className="spec-label">Write</span>
                                <span className="spec-value">{storageDevice.writeSpeed} MB/s</span>
                            </div>
                        )}
                        {storageDevice.rpm && (
                            <div className="spec-item">
